...
namespace ProdUI.Controls
{
    public static partial class Prod
    {
        ...
        public static bool WindowGetModal(IntPtr windowHandle)
        {
            try
            {
                return (bool) WindowPatternHelper.GetIsModal(AutomationElement.FromHandle(windowHandle));
            }
        ...
        public static bool WindowIsTopmost(IntPtr windowHandle)
        {
            try
            {
                return (bool) WindowPatternHelper.GetIsTopmost(AutomationElement.FromHandle(windowHandle));
            }
            catch (InvalidOperationException ex)
            {
                throw new ProdOperationException(ex);
        ...
        public static bool WindowWaitForIdle(IntPtr windowHandle, int delay)
        {
            try
            {
                bool retVal = (bool) WindowPatternHelper.WaitForInputIdle(AutomationElement.FromHandle(windowHandle), delay);
                return retVal;
            }
            catch (InvalidOperationException ex)
            {
