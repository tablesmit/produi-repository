    ...
    public sealed class ProdSlider : BaseProdControl
    {
        ...
        public void SetValue(double value)
        {
            ...
            try
            {
                ...
                int ret = RangeValuePatternHelper.SetValue(ThisElement, value);
        ...
        public double GetValue()
        {
            try
            {
                double retVal = RangeValuePatternHelper.GetValue(ThisElement);
        ...
        public double GetLargeChange()
        {
            try
            {
                double retVal = RangeValuePatternHelper.GetLargeChange(ThisElement);
        ...
        public double GetMaxValue()
        {
            try
            {
                double retVal = RangeValuePatternHelper.GetMaximum(ThisElement);
        ...
        public double GetMinValue()
        {
            try
            {
                double retVal = RangeValuePatternHelper.GetMinimum(ThisElement);
        ...
        public double GetSmallChange()
        {
            try
            {
                double retVal = RangeValuePatternHelper.GetSmallChange(ThisElement);
