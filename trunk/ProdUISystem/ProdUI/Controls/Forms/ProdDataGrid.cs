...
namespace ProdUI.Controls
{
    internal sealed class ProdDataGrid : BaseProdControl
    {
        ...
        public int GetColumnCount()
        {
            try
            {
                if (CheckPatternSupport(GridPattern.Pattern, ThisElement))
                {
                    int retVal = GridPatternHelper.GetColumnCount(ThisElement);
        ...
        public int GetRowCount()
        {
            try
            {
                if (CheckPatternSupport(GridPattern.Pattern, ThisElement))
                {
                    int retVal = GridPatternHelper.GetRowCount(ThisElement);
        ...
        public AutomationElement GetItem(int row, int column)
        {
            try
            {
                if (CheckPatternSupport(GridPattern.Pattern, ThisElement))
                {
                    AutomationElement retVal = GridPatternHelper.GetItem(ThisElement, row, column);
        ...
        { 
            ...
            try
            {
                if (CheckPatternSupport(SelectionItemPattern.Pattern, ThisElement))
                {
        ...
        public RowOrColumnMajor GetRowOrColumnMajor()
        {
            try
            {
                if (CheckPatternSupport(TablePattern.Pattern, ThisElement))
                {
                    RowOrColumnMajor retVal = TablePatternHelper.GetRowOrColumnMajor(ThisElement);
