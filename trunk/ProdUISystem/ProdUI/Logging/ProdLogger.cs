...
namespace ProdUI.Logging
{
    ...
    public class ProdLogger
    {
        ...
        /// <summary>Creates a ProdLogger.</summary>
        ...
        /// <summary>Writes the log message to the desired output log</summary>
        ...
        /// <summary>Verifies the log level of the current message against the loggers level.</summary>
        /// <param name="logger">The logger.</param>
        /// <returns><c>true</c> if message is to be logged, <c>false</c> otherwise</returns>
        ...
        /// <summary>Formats the output string in the loggers desired format.</summary>
        /// <param name="logger">The logger.</param>
        /// <remarks>Accessible by calling ToString() on LogMessage</remarks>
