...
namespace ProdEhllapi
{
    ...
    public class EhllapiFunctions
    {
        ...
        ///</summary>
        ///<returns>0 if successful, anything else for an error</returns>
        ///<remarks>
        ///  <pre>
        ///    Return codes:
        ...
        /// <returns>location as a 2 element array = row,column</returns>
        ...
        /// <returns>The decimal value of the return from the emulator</returns>
        /// <remarks>
        ...
        ///<returns>0 if string not found, location otherwise</returns>
        ///<remarks>
        ///  <pre>
        ...
        /// <param name = "row">The fields row.</param>
        /// <param name = "col">The fields column.</param>
        /// <returns>Beginning position of the current field</returns>
        ...
        /// <param name = "row">The fields row.</param>
        /// <param name = "col">The fields column.</param>
        /// <returns>length of target field</returns>
        ...
        ///   This function can be used to find either protected or unprotected fields but only in a field-formatted host presentation space
        /// </remarks>
        /// <returns>Length of the current field</returns>
        ...
        ///</summary>
        ///<returns>0 if no update has been made, 22 if the presentation space was updated. anything else for an error</returns>
        ///<remarks>
        ///  <pre>
