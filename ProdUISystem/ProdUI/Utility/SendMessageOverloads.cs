...
namespace ExpandCollapseState
{
    internal static partial class NativeMethods
    {
        ...
        /// </returns>
        [DllImport("user32.dll", SetLastError = true)]
        internal static extern uint SendMessage(IntPtr windowHandle, [MarshalAs(UnmanagedType.SysInt)] int msg, [MarshalAs(UnmanagedType.SysInt)] int wParam, [MarshalAs(UnmanagedType.SysUInt)] uint lParam);
