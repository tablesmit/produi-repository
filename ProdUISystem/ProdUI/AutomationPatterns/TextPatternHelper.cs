...
namespace ProdUI.AutomationPatterns
{
    ...
    internal static class TextPatternHelper
    {
        ...
        {
            TextPattern pat = (TextPattern)CommonPatternHelpers.CheckPatternSupport(TextPattern.Pattern, control);
        ...
        internal static void AddToSelection(AutomationElement control, TextPatternRange targetRange)
        {
            try
            {
                if (GetSupportedTextSelection(control) != SupportedTextSelection.Multiple)
                {
                    return;
                }
        ...
        /// <summary>Expands the text range to the specified TextUnit.</summary>
        /// <param name="control">The control.</param>
        ...
        /// <summary>Finds the desired text within the whole document text.</summary>
        /// <param name="control">The control.</param>
        ...
        internal static void Select(AutomationElement control, string find, bool ignoreCase)
        {
            try
            {
                ...
                if (range == null)
                {
                    throw new ProdOperationException("Text Not Found");
                }
                range.Select();
